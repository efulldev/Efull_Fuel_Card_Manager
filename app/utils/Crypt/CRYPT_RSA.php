...
// require_once(app_path() . '/utils/Crypt/RSA/ErrorHandler.php');
use App\utils\Crypt\RSA\Crypt_RSA_ErrorHandler;
/**
 * loader for math wrappers
 */
// require_once './RSA/MathLoader.php';
use App\utils\Crypt\RSA\MathLoader;
...
use App\utils\Crypt\RSA\Crypt_RSA_Key;

/**
 * helper class for manage key pair
 */
// require_once './RSA/KeyPair.php';
use App\utils\Crypt\RSA\KeyPair;
